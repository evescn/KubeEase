...
// GetDaemonSets 获取daemonset列表，支持过滤，排序，分页，client用于选择哪个集群
func (d *daemonSet) GetDaemonSets(client *kubernetes.Clientset, filterName, namespace string, size, page int) (dssResp *vo.DaemonSetsResp, err error) {
