...
// client用于选择哪个集群
func (i *ingress) GetIngresses(client *kubernetes.Clientset, filterName, namespace string, size, page int) (ingressesResp *vo.IngressesResp, err error) {
...
func (i *ingress) CreateIngress(client *kubernetes.Clientset, data *vo.IngressCreate) (err error) {
