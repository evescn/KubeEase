...
func (c *secret) GetSecrets(client *kubernetes.Clientset, filterName, namespace string, size, page int) (secretsResp *vo.SecretsResp, err error) {
...
// UpdateSecret 更新 Secret content就是StatefulSet的整个json体
