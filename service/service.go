...
// client用于选择哪个集群
func (s *servicev1) GetServices(client *kubernetes.Clientset, filterName, namespace string, size, page int) (servicesResp *vo.ServicesResp, err error) {
...
func (s *servicev1) CreateService(client *kubernetes.Clientset, data *vo.ServiceCreate) (err error) {
