...
// GetStatefulSets 获取StatefulSet列表，支持过滤，排序，分页， client用于选择哪个集群
func (s *statefulSet) GetStatefulSets(client *kubernetes.Clientset, filterName, namespace string, size, page int) (statefulSetResp *vo.StatefulSetResp, err error) {
